...
const DOCUMENTS: Record<string, LegalDocument> = {
  terms: {
    ...
    introduction:
      "Ces règles protègent les membres de Mbolo et définissent les conditions d’accès à la plateforme.",
    sections: [
  ...
  privacy: {
    ...
    introduction:
      "Mbolo applique la minimisation des données, la confidentialité par défaut et des contrôles d’accès adaptés.",
    sections: [
  ...
  cookies: {
    ...
    introduction:
      "La version actuelle de Mbolo utilise uniquement les éléments indispensables au fonctionnement et à la sécurité.",
    sections: [
  ...
  community: {
    ...
    introduction:
      "Mbolo doit rester un espace de rencontres authentiques, respectueuses et sûres.",
    sections: [
  ...
  return (
    <main className="legal-page">
      <header className="legal-page__hero">
        ...
        <small>Version applicable : 24 juillet 2026</small>
      </header>
